-- Script para arreglar la base de datos Market-X
...
INSERT IGNORE INTO admin_users (username, password, email, role, is_active) VALUES 
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@marketx.local', 'super_admin', 1);

-- También agregar admin a tabla users por compatibilidad
INSERT IGNORE INTO users (username, password, email, is_vendor, vendor_approved) VALUES 
